...
#         num_cineloop_with_only_1_frame = 0
        ...
        for PatientStudy in self.PatientStudy_list:
            ...
            all_TiffFilename_this_PatientStudy = []
            #get all tiff files for this PatientStudy
            for dir in ['labeled', 'unlabeled']:
                for filename in os.listdir(os.path.join(self.data_root_dir, dir)):
                    if PatientStudy in filename:
                        all_TiffFilename_this_PatientStudy.append(os.path.join(self.data_root_dir, dir, filename))
